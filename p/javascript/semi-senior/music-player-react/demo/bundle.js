...
/******/ 	var hotCurrentHash = "495531e805c8699aa43f"; // eslint-disable-line no-unused-vars
...
var Home = exports.Home = function (_React$Component) {
    ...
    function Home() {
        ...
        _this.state = {
            songs: [{ title: "South Park", id: "south-park", author: 'Kyle', url: "https://assets.breatheco.de/apis/sound/files/mario/songs/castle.mp3" }, { title: "Thunder Cats", id: "thundercats", author: 'Moonra', url: "https://assets.breatheco.de/apis/sound/files/videogame/fx_zelda_recorder.wav" }, { title: "X-Men", id: "x-men", author: 'Profesor', url: "https://assets.breatheco.de/apis/sound/files/cartoons/songs/x-men.mp3" }]
        };
        _this.player = null;
        return _this;
    }
        ...
        value: function render() {
            ...
            var songs = this.state.songs.map(function (song, i) {
                return _react2.default.createElement(
                    "div",
                    { key: i, className: "track", onClick: function onClick() {
                            _this2.play(song.url);
                        } },
                    ...
                    _react2.default.createElement(
                        "div",
                        { className: "track__title featured" },
                        _react2.default.createElement(
                            "span",
                            { className: "title" },
                            song.title
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        "div",
                        { className: "current-track__actions" },
                        _react2.default.createElement(
                            "a",
                            { className: "skipbackward" },
                            _react2.default.createElement("i", { className: "fas fa-caret-square-left" })
                        ),
                        _react2.default.createElement(
                            "a",
                            { ref: function ref(elm) {
                                    return _this2.playBtn = elm;
                        ...
                        _react2.default.createElement(
                            "a",
                            { ref: function ref(elm) {
                                    return _this2.pauseBtn = elm;
                                }, onClick: function onClick() {
                                    return _this2.pause();
                                } },
                            _react2.default.createElement("i", { className: "fas fa-pause-circle" })
                        ),
                        _react2.default.createElement(
                            "a",
                            { className: "skipforward" },
                            _react2.default.createElement("i", { className: "fas fa-caret-square-right" })
                        )
                    )
                ),
                _react2.default.createElement("audio", { ref: function ref(t) {
                        return _this2.player = t;
                    }, controls: true })
            );
        }
    }]);
...
var _home = __webpack_require__(/*! ./component/home.jsx */ "./src/js/component/home.jsx");
