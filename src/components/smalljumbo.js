		...
		return (
			<div className={this.props.jumboClass}>
				<div className={this.props.containerClass}>
                    <img height="45px" className="float-left mr-2 mt-3" alt="BreatheCode Icon" src="https://assets.breatheco.de/apis/img/images.php?blob&random&cat=icon&tags=breathecode,64" />
